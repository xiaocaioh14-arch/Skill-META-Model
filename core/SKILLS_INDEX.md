...
| 属性 | 值 |
|------|-----|
| **路径** | `/Users/wyw/Project/碎片思想出文skill/thought-to-article/` |
| **Skill 名称** | `thought-to-article` |
| **有 SKILL.md** | ✅ 有（350+ 行） |
| **状态** | ✅ 完整可用 |

**功能特性：**
- 💬 **对话驱动创作** — 多轮对话挖掘用户碎片想法，六维完整度雷达追踪素材丰富度
- 🧬 **风格DNA迁移** — 从参考文章提取6维度风格特征，约束新内容生成
- ✨ **高金句密度** — 八大金句结构模式，每300字至少1个可截图金句
- 🎨 **SVG原创配图** — Python脚本生成2-3张契合文风的SVG配图
- 📄 **双格式输出** — MD（含图片引用）+ 公众号适配HTML（内联SVG）

**触发方式：**
```bash
"我有个想法想写成文章" / "碎片想法出文" / "出文" / "整理成文"
```

**创新模式：**
- ✨ 引入了**"模式 13: 对话驱动式创作"**设计模式
- ✨ 引入了**"模式 14: 风格DNA提取与迁移"**设计模式
...
| 状态 | 数量 | Skills |
|------|------|--------|
| ✅ **已有 SKILL.md** | 13 | 全部 Skills 已完成 SKILL.md 文档 |
| ❌ **待创建 SKILL.md** | 0 | — |
